...
with st.sidebar:
    ...
    examples = [
        ...
        ("How is the PPO Point-of-Service different from Standard?", "posvsstd"),
        ("What is DeltaVision and how does it work?", "deltavision"),
        ("What benefits exist for people with special health care needs?", "shcn"),
        ("Does Medicare cover dental? What are my options?", "medicare"),
